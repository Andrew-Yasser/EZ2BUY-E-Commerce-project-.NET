...
namespace Ez2Buy.DataAccess.Migrations
{
    ...
    [Migration("20250421154620_addOrderHeaderAndDetailsToDb")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Ez2Buy.DataAccess.Models.OrderDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Ez2Buy.DataAccess.Models.OrderHeader", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Ez2Buy.DataAccess.Models.ShoppingCart", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Ez2Buy.DataAccess.Models.OrderDetail", b =>
                {
                    b.HasOne("Ez2Buy.DataAccess.Models.OrderHeader", "OrderHeader")
                        .WithMany()
                        .HasForeignKey("OrderHeaderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Ez2Buy.DataAccess.Models.Product", "Product")
                        .WithMany()
            ...
            modelBuilder.Entity("Ez2Buy.DataAccess.Models.OrderHeader", b =>
                {
                    b.HasOne("Ez2Buy.DataAccess.Models.AppUser", "AppUser")
                        .WithMany()
